    ...
    public sealed class AsyncLock
    {
        ...
        public Task<IDisposable> LockAsync()
        {
            ...
            return wait.IsCompleted ? 
                _mReleaser : 
                wait.ContinueWith((_, state) => (IDisposable)state, _mReleaser.Result, CancellationToken.None, TaskContinuationOptions.ExecuteSynchronously, TaskScheduler.Default);
        }
